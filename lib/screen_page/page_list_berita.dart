...
import 'package:uts_mobile_smt4/screen_page/page_login_api.dart';
  ...
  Future<List<Datum>?> getBerita() async {
    try {
      ...
      http.Response response = await http.get(
        Uri.parse("http://192.168.100.128/uts_mobile/berita.php"),
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          TextButton(onPressed: () {}, child: Text('Hi ... ${session.userName}', style: TextStyle(color: Colors.grey), )),
          // Logout
          IconButton(
            onPressed: () {
              // Clear session
                              ...
                              children: [
                                Padding(
                                    ...
                                    child: ClipRRect(
                                      ...
                                      child: Image.network('http://192.168.100.128/uts_mobile/image/${data.gambar}',
                                        fit: BoxFit.fill,
                                      ),
                                    )
                                ),
